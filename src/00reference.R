...
chicagocrimes20122017 <- fread("./data/참고용데이터/Chicago_Crimes_2012_to_2017.csv")
chicagocrimes20122017 = as.data.frame(chicagocrimes20122017)
...
chicagocrimes20122015$Date <- na.omit(mdy_hms(chicagocrimes20122015$Date, "%m/%d/%Y %I:%M:%S %p"))
